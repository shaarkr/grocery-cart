<template>
  <div
    class="fixed inset-0 z-[100] backdrop-blur-sm backdrop-brightness-50 flex flex-col items-center justify-end">
    <div
      class="transition duration-150 relative w-full pt-8 rounded-t-lg bg-white before:cursor-pointer before:absolute before:top-4 before:left-1/2 before:-translate-x-1/2 before:h-1 before:w-12 before:bg-gray-200 before:rounded-lg">
      <!-- Controls -->
      <div class="w-full grid grid-cols-5 items-center text-center px-4 py-2">
        <button type="button" class="p-2 bg-transparent outline-none text-zinc-900">
